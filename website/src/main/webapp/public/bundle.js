...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainCarousel = __webpack_require__(208);

	var _MainCarousel2 = _interopRequireDefault(_MainCarousel);

	var _MainMap = __webpack_require__(210);

	var _MainMap2 = _interopRequireDefault(_MainMap);

	var _Wreck = __webpack_require__(211);
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { id: 'main' }, _react2.default.createElement(_navbar2.default, null), _react2.default.createElement('div', { id: 'map-container', className: 'collapse in' }, _react2.default.createElement(_MainMap2.default, null)), _react2.default.createElement('div', { className: 'data-container' }, this.props.children));
	        }
	    }]);
	...
	var routes = _react2.default.createElement(_reactRouter.Route, { path: '/', component: App }, _react2.default.createElement(_reactRouter.IndexRoute, { component: App }), _react2.default.createElement(_reactRouter.Route, { path: '/wreck', component: _Wreck2.default }), _react2.default.createElement(_reactRouter.Route, { path: '/fauna', component: App }), _react2.default.createElement(_reactRouter.Route, { path: '/advice', component: App }), _react2.default.createElement(_reactRouter.Route, { path: '/team', component: App }));

	_reactDom2.default.render(_react2.default.createElement(_reactRouter.Router, { id: 'router' }, routes), document.getElementById('app'));
	...
	var Navbar = (function (_React$Component) {
	  ...
	  _createClass(Navbar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('nav', { className: 'navbar navbar-fixed-top' }, _react2.default.createElement('div', { className: 'container-fluid' }, _react2.default.createElement('div', { className: 'navbar-header' }, _react2.default.createElement('button', { type: 'button', className: 'navbar-toggle collapsed', 'data-toggle': 'collapse', 'data-target': '#bs-example-navbar-collapse-1', 'aria-expanded': 'false' }, _react2.default.createElement('span', { className: 'sr-only' }, 'Toggle navigation'), _react2.default.createElement('span', { className: 'icon-bar' }), _react2.default.createElement('span', { className: 'icon-bar' }), _react2.default.createElement('span', { className: 'icon-bar' })), _react2.default.createElement('a', { className: 'navbar-brand', href: '#' }, 'GREEC')), _react2.default.createElement('div', { className: 'collapse navbar-collapse', id: 'bs-example-navbar-collapse-1' }, _react2.default.createElement('ul', { className: 'nav navbar-nav' }, _react2.default.createElement('li', { role: 'presentation' }, _react2.default.createElement(_reactRouter.Link, { to: '/wreck', activeClassName: 'link-active' }, 'Les Epaves')), _react2.default.createElement('li', { role: 'presentation' }, _react2.default.createElement(_reactRouter.Link, { to: '/fauna', activeClassName: 'link-active' }, 'La Faune')), _react2.default.createElement('li', { role: 'presentation' }, _react2.default.createElement(_reactRouter.Link, { to: '/advice', activeClassName: 'link-active' }, 'Conseils')), _react2.default.createElement('li', { role: 'presentation' }, _react2.default.createElement(_reactRouter.Link, { to: '/team', activeClassName: 'link-active' }, 'L\'Equipe'))), _react2.default.createElement('div', { className: 'map-toolbar' }, _react2.default.createElement('button', { onClick: this.toggleMap.bind(this), type: 'button', className: 'btn btn-default',
	        'data-toggle': 'collapse', 'data-target': '#map-container', 'aria-expanded': 'true', 'aria-controls': 'map-container' }, _react2.default.createElement('i', { className: expandButtonClass }))))));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainCarousel = (function (_React$Component) {
	    ...
	    function MainCarousel(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MainCarousel).call(this, props));
	    }
	    ...
	    _createClass(MainCarousel, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("div", { id: "carousel-example-generic", className: "carousel slide", "data-ride": "carousel" }, _react2.default.createElement("ol", { className: "carousel-indicators" }, _react2.default.createElement("li", { "data-target": "#carousel-example-generic", "data-slide-to": "0", className: "active" }), _react2.default.createElement("li", { "data-target": "#carousel-example-generic", "data-slide-to": "1" }), _react2.default.createElement("li", { "data-target": "#carousel-example-generic", "data-slide-to": "2" })), _react2.default.createElement("div", { className: "carousel-inner", role: "listbox" }, _react2.default.createElement("div", { className: "item active" }, _react2.default.createElement("img", { src: "./app/resources/slide-01.jpg", className: "img-responsive center-block", alt: "Responsive image" }), _react2.default.createElement("div", { className: "carousel-caption" }, "Hellcat")), _react2.default.createElement("div", { className: "item" }, _react2.default.createElement("img", { src: "./app/resources/slide-02.jpg", className: "img-responsive center-block", alt: "Responsive image" }), _react2.default.createElement("div", { className: "carousel-caption" }, "Relax")), _react2.default.createElement("div", { className: "item" }, _react2.default.createElement("img", { src: "./app/resources/slide-03.jpg", className: "img-responsive center-block", alt: "Responsive image" }), _react2.default.createElement("div", { className: "carousel-caption" }, "ambiance"))), _react2.default.createElement("a", { className: "left carousel-control", href: "#carousel-example-generic", role: "button", "data-slide": "prev" }, _react2.default.createElement("span", { className: "glyphicon glyphicon-chevron-left", "aria-hidden": "true" }), _react2.default.createElement("span", { className: "sr-only" }, "Previous")), _react2.default.createElement("a", { className: "right carousel-control", href: "#carousel-example-generic", role: "button", "data-slide": "next" }, _react2.default.createElement("span", { className: "glyphicon glyphicon-chevron-right", "aria-hidden": "true" }), _react2.default.createElement("span", { className: "sr-only" }, "Next")));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wreck = (function (_React$Component) {
	    ...
	    _createClass(Wreck, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("div", { className: "container-fluid data-container" }, _react2.default.createElement("div", { className: "row" }, _react2.default.createElement("div", { className: "col-md-10 col-md-offset-1" }, _react2.default.createElement(PresentationComponent, { data: this.state.wreck }))));
	        }
	    }]);
	...
	var PresentationComponent = (function (_React$Component2) {
	    _inherits(PresentationComponent, _React$Component2);

	    function PresentationComponent(props) {
	        _classCallCheck(this, PresentationComponent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PresentationComponent).call(this, props));
	    }

	    _createClass(PresentationComponent, [{
	        key: "getThumbnail",
	        value: function getThumbnail(src) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("div", null, _react2.default.createElement("div", { className: "media" }, _react2.default.createElement("div", { className: "media-left" }, _react2.default.createElement("img", { className: "media-object img-thumbnail", src: thumbnailPath, alt: this.props.data.name })), _react2.default.createElement("div", { className: "media-body" }, _react2.default.createElement("h1", { className: "media-heading" }, this.props.data.name), _react2.default.createElement(PresentationHeader, null), _react2.default.createElement(PresentationBody, { data: this.props.data }))));
	        }
	    }]);
	...
	var PresentationBody = (function (_React$Component3) {
	    _inherits(PresentationBody, _React$Component3);

	    function PresentationBody(props) {
	        _classCallCheck(this, PresentationBody);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PresentationBody).call(this, props));
	    }

	    _createClass(PresentationBody, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("div", { className: "presentation-body" }, _react2.default.createElement("p", { className: "lead" }, this.props.data.header), _react2.default.createElement("p", null, this.props.data.description));
	        }
	    }]);
	...
	var PresentationHeader = (function (_React$Component4) {
	    _inherits(PresentationHeader, _React$Component4);

	    function PresentationHeader(props) {
	        _classCallCheck(this, PresentationHeader);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PresentationHeader).call(this, props));
	    }

	    _createClass(PresentationHeader, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("div", null, _react2.default.createElement("ul", { className: "nav nav-tabs" }, _react2.default.createElement("li", { role: "presentation", className: "active" }, _react2.default.createElement("a", { href: "#" }, "Présentation")), _react2.default.createElement("li", { role: "presentation" }, _react2.default.createElement("a", { href: "#" }, "Sites de plongées")), _react2.default.createElement("li", { role: "presentation" }, _react2.default.createElement("a", { href: "#" }, "Media"))));
	        }
	    }]);
